      ...
      {({ open }) => (
        <div className="flex flex-col bg-slate-50 sm:px-2 px-6 shadow-md border-solid border-t-2 pb-2">
          ...
          <div className="flex justify-between flex-shrink  lg:w-auto w-full  pb-5 lg:pb-0">
            ...
            <div className="mt-6 text-md font-bold text-yellow-700 mx-12 sm:hidden">
              <Link
                to="/login"
                className="mt-4 lg:inline-block hover:text-white px-4 py-2  rounded hover:bg-yellow-500 mr-8"
              >
                Log in
              </Link>
