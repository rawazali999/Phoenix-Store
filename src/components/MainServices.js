...
export default function MainServices() {
  return (
    <div className="w-11/12 mx-auto  my-24 ">
      <div className="flex items-center justify-center text-3xl font-bold py-4 text-custom1 dark:text-gray-100">
      Why Shop With Us
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  m-auto p-6">
        <div className="flex  flex-col justify-center items-center text-cyan-800 dark:text-gray-200 border-r my-2 py-4 ">
          <LocalShippingOutlinedIcon   sx={{ color: "inherit" ,fontSize: "50px"}}  />
        ...
        <div className="flex  flex-col justify-center items-center text-cyan-800 dark:text-gray-200  border-r my-2 py-4 ">
          <SupportAgentOutlinedIcon  sx={{ color: "inherit",fontSize: "50px" }} />
