    ...
    <div className="relative mt-16 bg-custom4">
      ...
      <div className="px-4 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="grid grid-cols-2  row-gap-8  lg:col-span-4 md:grid-cols-3">
            <div  >
            ...
            <div className="md:max-w-md  px-2 -ml-4 lg:col-span-1">
              ...
              <form className="flex flex-col mt-4 md:flex-row">
                <input
                  ...
                  required
                  type="text"
                  className="flex-grow w-56 sm:w-56 md:w-40 h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none md:mr-2 md:mb-0 focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                />
                <button
                  type="submit"
      ...
      <div className="flex flex-col justify-between px-6 py-5 border-t-2 sm:flex-row">
